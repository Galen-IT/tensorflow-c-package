...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            ...
            url: "https://github.com/galen-it/tensorflow-ios-package/releases/download/2.7.0.1/TensorFlowLiteC.xcframework.zip",
            checksum: "86c944d7b108f2f27a637bdb9cc6685ed93f27ee5acbbf1663a12d2da856a014"
        ),
        .binaryTarget(
            name: "TensorFlowLiteCCoreML",
            url: "https://github.com/galen-it/tensorflow-ios-package/releases/download/2.7.0.1/TensorFlowLiteCCoreML.xcframework.zip",
            checksum: "651840dc4619804503d5deb288806cfa24e67d311fbec5882bebccffd0c7d376"
        ),
        .binaryTarget(
            name: "TensorFlowLiteCMetal",
            url: "https://github.com/galen-it/tensorflow-ios-package/releases/download/2.7.0.1/TensorFlowLiteCMetal.xcframework.zip",
